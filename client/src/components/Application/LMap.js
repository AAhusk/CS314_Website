...
export default class LMap extends Component {
	...
	markerIcon(url = icon) {
		...
		const iconAnchorValue = [this.props.options.markerSize/4, this.props.options.markerSize]
		return L.icon({
			iconUrl: this.props.options.colorURL,
			iconSize: [this.props.options.markerSize/2, this.props.options.markerSize],
